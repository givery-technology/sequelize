  ...
  */
  ...
  Model.prototype.restore = function(options) {
    ...
    return Promise.try(function() {
      ...
      // Run undelete query
      var attrValueHash = {};
      attrValueHash[self._timestampAttributes.deletedAt] = 0;
  ...
  var paranoidClause = function(model, options) {
    ...
    deletedAtObjectZero[model.rawAttributes[deletedAtCol].field || deletedAtCol] = 0;
    deletedAtObject = model.sequelize.or(deletedAtObjectZero, deletedAtObject);
